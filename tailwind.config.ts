...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        "glow-sm":
          "0 0 6px -1px hsl(var(--primary) / 0.4), 0 0 4px -2px hsl(var(--primary) / 0.3)",
        glow: "0 0 15px -3px hsl(var(--primary) / 0.4), 0 0 8px -4px hsl(var(--primary) / 0.3)",
        "glow-lg":
          "0 0 25px -5px hsl(var(--primary) / 0.4), 0 0 15px -6px hsl(var(--primary) / 0.3)",
      },
      backgroundImage: {
        ...
        "gradient-cool":
          "linear-gradient(135deg, hsl(var(--info)) 0%, hsl(var(--primary)) 100%)",
        "gradient-success":
